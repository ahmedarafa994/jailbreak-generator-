...
class RoBERTaPredictor(Predictor):
    def __init__(self, path, device='cuda'):
        ...
        try:
            ...
            logging.error(f"Failed to initialize RoBERTaPredictor: {e}")
            raise RuntimeError(f"Failed to initialize RoBERTaPredictor: {e}")
    ...
    def predict(self, sequences):
        ...
        try:
            ...
            logging.error(f"Failed to predict in RoBERTaPredictor: {e}")
            return []
