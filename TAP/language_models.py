...
class PaLM():
    ...
    def __init__(self, model_name) -> None:
        ...
        try:
            ...
            print(f"Failed to initialize PaLM model: {e}")
            self.model = None
    ...
    def generate(self, conv: List, 
        ...
        if self.model is None:
            print("PaLM model is not initialized.")
            return output
        for _ in range(self.API_MAX_RETRY):            
            try:
...
class GeminiPro():
    ...
    def __init__(self, model_name) -> None:
        ...
        try:
            ...
            print(f"Failed to initialize GeminiPro model: {e}")
            self.model = None
    ...
    def generate(self, conv: List, 
        ...
        output = self.API_ERROR_OUTPUT
        if self.model is None:
            print("GeminiPro model is not initialized.")
            return output
        for _ in range(self.API_MAX_RETRY):            
            try:
                output = self.model.generate_content(
